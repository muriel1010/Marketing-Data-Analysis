...
def fetch_data_from_sql():
    ...
    conn_str = (
        ...
        "Server=LAPTOP-00VI9ATL\SQLEXPRESS;"  # Specify your SQL Server instance
    ...
    query = "SELECT ReviewID, CustomerID, ProductID, ReviewDate, Rating, ReviewText FROM fact_customer"
